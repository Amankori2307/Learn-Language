  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[var(--size-chart-tooltip-min-width)] items-start gap-1.5 rounded-[var(--radius-md)] border border-border/50 bg-background px-2.5 py-1.5 text-xs [box-shadow:var(--shadow-lg)]",
          className,
        )}
      >
                  ...
                  <>
                    {itemConfig?.icon ? (
                      ...
                      !hideIndicator && (
                        <div
                          className={cn(
                            "shrink-0 rounded-[var(--size-chart-indicator-radius)] border-[--color-border] bg-[--color-bg]",
                            {
        ...
        return (
          ...
          >
            {itemConfig?.icon && !hideIcon ? (
              ...
              <div
                className="h-2 w-2 shrink-0 rounded-[var(--size-chart-indicator-radius)]"
                style={{
