...
| P8-004 | doing | Sidebar UX cleanup (declutter IA, grouping, labels, spacing, visual hierarchy, responsive behavior) | P8-001 | M | sidebar has reduced clutter, clear primary/secondary groups, consistent spacing/icons, active state clarity, and no overflow issues on common laptop widths |
