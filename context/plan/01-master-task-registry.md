...
| ID | Status | Task | Depends On | Effort | Done When |
|---|---|---|---|---|---|
| P6-028 | todo | Redesign Clusters page into list/table view with search, filters, sort controls, and pagination | - | M | clusters page supports text search, type/language filters, sortable columns (name, type, wordCount), paginated results with stable query params, and empty/loading states in both light/dark themes |
