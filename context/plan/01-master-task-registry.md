...
| ID | Status | Task | Depends On | Effort | Done When |
|---|---|---|---|---|---|
| P1-001 | doing | Normalize schema for words/clusters/sentences/progress fields | P0-003 | M | schema reflects contract in `70-schema-and-api-contracts.md` |
| P1-002 | todo | Add DB indexes for quiz selection and review due lookups | P1-001 | S | query plans use indexes for target endpoints |
