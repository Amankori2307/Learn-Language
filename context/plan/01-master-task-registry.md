...
| ID | Status | Task | Depends On | Effort | Done When |
|---|---|---|---|---|---|
| P6-021 | todo | Fix quiz option state reset between questions (previous selection/highlight must not persist) | P6-014 | S | after submit/continue and next question load, no option is preselected/highlighted unless user selects it; verified for correct/incorrect paths and all quiz modes |
